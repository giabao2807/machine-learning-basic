...
def search_pair(a,p,q,m):
	...
	if l<=(3): return (halves_search(a,p,q,m)) #nếu length <=3 sử dụng thuật toán brute force
...
m=lenght (points[0],points[1]) #giả sử khoảng cách của 2 điểm đầu tiên là ngắn nhất
